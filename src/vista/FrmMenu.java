...
public class FrmMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem_crear_usuario.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_crear_usuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/nuevo-cliente.png"))); // NOI18N
        jMenuItem_crear_usuario.setText("Nuevo usuario");
        jMenuItem_crear_usuario.setPreferredSize(new java.awt.Dimension(180, 30));
        ...
        jMenu1.add(jMenuItem_crear_usuario);
        ...
        jMenuItem_nueva_factura.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_nueva_factura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/anadir.png"))); // NOI18N
        jMenuItem_nueva_factura.setText("Nueva venta");
        jMenuItem_nueva_factura.setPreferredSize(new java.awt.Dimension(200, 30));
        jMenuItem_nueva_factura.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem_nueva_facturaActionPerformed(evt);
            }
        });
        jMenu5.add(jMenuItem_nueva_factura);

        jMenuItem_gestionar_factura.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jMenuItem_gestionar_factura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/configuraciones.png"))); // NOI18N
        jMenuItem_gestionar_factura.setText("Gestionar venta");
    ...
    private void jMenuItem_nueva_facturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_nueva_facturaActionPerformed
    ...
    }//GEN-LAST:event_jMenuItem_nueva_facturaActionPerformed
    ...
    private void jMenuItem_gestionar_facturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_gestionar_facturaActionPerformed
        InterGestionarVentas intergestionarFacturacion = new InterGestionarVentas();
        jDesktopPane_menu.add(intergestionarFacturacion);
        intergestionarFacturacion.setVisible(true);
    ...
    private javax.swing.JMenuItem jMenuItem_crear_usuario;
